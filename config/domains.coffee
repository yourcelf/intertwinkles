...
module.exports = {
  ...
  front_end_url: "http://intertwinkles.org"
  ...
  etherpad_cookie_domain: ".intertwinkles.org"
  # Domain for the alpha warning cookie.
  alpha_cookie_domain: ".intertwinkles.org"
  # Email address for the 'From' header in server-generated emails
  from_email: "notices@intertwinkles.org"
